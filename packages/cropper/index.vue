 ...
 * @Author: your name
 * @Date: 2019-09-05 20:35:22
 * @LastEditTime: 2019-09-11 17:02:29
 * @LastEditors: Please set LastEditors
 -->
<template>
  <div :class="b()" :style="style">
    <div :class="b('cropper')" ref="cropper" @mouseover="scaleImg" @mouseout="cancelScale">
      <div :class="b('box')">
        <div
          :class="b('box-canvas')"
          v-show="!loading"
      ...
      <div
        :class="b(['drag-box',{'move': move && !crop, 'crop': crop, 'modal': cropping}])"
        @mousedown="startMove"
      ...
      >
        <span :class="b('view-box')">
          <img
            :style="{
              'width': trueWidth + 'px',
              'height': trueHeight + 'px',
              'transform': 'scale(' + scale + ',' + scale + ') ' + 'translate3d('+ (x - cropOffsertX) / scale + 'px,'
                + (y - cropOffsertY) / scale + 'px,' +'0)' + 'rotateZ('+ rotate * 90 +'deg)'
            }"
            :src="imgs"
            alt="cropper-img"
          >
        </span>
        <span :class="b(['face','move'])" @mousedown="cropMove" @touchstart="cropMove" />
        <span
          :class="b('info')"
          v-if="info"
        ...
        <span v-if="!fixedBox">
          ...
          />
          <span
            :class="b('point','point1')"
            @mousedown="changeCropSize($event, true, true, 1, 1)"
            @touchstart="changeCropSize($event, true, true, 1, 1)"
          />
          <span
            :class="b('point','point2')"
            @mousedown="changeCropSize($event, false, true, 0, 1)"
            @touchstart="changeCropSize($event, false, true, 0, 1)"
          />
          <span
            :class="b('point','point3')"
            @mousedown="changeCropSize($event, true, true, 2, 1)"
            @touchstart="changeCropSize($event, true, true, 2, 1)"
          />
          <span
            :class="b('point','point4')"
            @mousedown="changeCropSize($event, true, false, 1, 0)"
            @touchstart="changeCropSize($event, true, false, 1, 0)"
          />
          <span
            :class="b('point','point5')"
            @mousedown="changeCropSize($event, true, false, 2, 0)"
            @touchstart="changeCropSize($event, true, false, 2, 0)"
          />
          <span
            :class="b('point','point6')"
            @mousedown="changeCropSize($event, true, true, 1, 2)"
            @touchstart="changeCropSize($event, true, true, 1, 2)"
          />
          <span
            :class="b('point','point7')"
            @mousedown="changeCropSize($event, false, true, 0, 2)"
            @touchstart="changeCropSize($event, false, true, 0, 2)"
          />
          <span
            :class="b('point','point8')"
            @mousedown="changeCropSize($event, true, true, 2, 2)"
            @touchstart="changeCropSize($event, true, true, 2, 2)"
          />
        </span>
      </div>
      <div :class="b('button-bar')">
        <span :class="b('cancel')" @click="cancelClick">取消</span>
        <span :class="b('determine')" @click="determineClick">确定</span>
      </div>
    </div>
  </div>
</template>
