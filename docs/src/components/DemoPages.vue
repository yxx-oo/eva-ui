 ...
 * @Author: your name
 * @Date: 2019-08-15 17:52:25
 * @LastEditTime: 2019-08-15 18:36:03
 * @LastEditors: Please set LastEditors
 -->
<template>
  <section class="eva-doc-demo-pages">
    <h2>{{ $t('title') }}</h2>
    <p>{{ $t('description') }}</p>
    <div class="eva-doc-demo-pages__gallery">
      <div
        :class="['eva-doc-demo-pages__item', { 'eva-doc-demo-pages__item--active': index === currentDemo }]"
